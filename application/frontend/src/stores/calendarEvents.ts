 ...
 * 
  ...
  @returns {calendarEventType[]} Array of events sorted chronologically, newer to latest. Returns empty array if data is empty.
*/
...
/**
 *
 * @param {calendarEventType[]} calendarEvents
 * @returns {YearClass[]} Converts all Events sent by the backend into a data model better suited for the frontend. Can return empty array.
 */
